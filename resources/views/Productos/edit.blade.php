...
<div class="max-w-2xl mx-auto">
    ...
    <div class="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-10 shadow-2xl">
        <h1 class="text-4xl font-orbitron tracking-wider bg-gradient-to-r from-neon-cyan to-neon-purple bg-clip-text text-transparent drop-shadow-neon mb-12 text-center">EDITAR PRODUCTO</h1>
        ...
        <form method="POST" action="{{ route('producto.update', $producto->id) }}" class="space-y-8">
            @csrf
            @method('PUT')
